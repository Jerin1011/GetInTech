...
//		String correcttext=d
	...
	public void getTitle() {
		...
		System.out.println("Page Main Title = "+ title);
	}
	public void getURL() {
...
//		js.executeScript("aruguments[0].scrollIntoView(true)", value);
	...
	public void ifElse(String orignalvalue) {
		if(orignalvalue.equals(text2)) {
			driverClose();
			System.out.println("Invalid Crentiacials or Not able to Log in");
		}else {
			getTitle();
			driverClose();
		}
